...
$edit = $_GET['edit'];
$re = mysqli_query($con,"SELECT * FROM nod WHERE Id ='$edit'");
...
if(isset($_POST['submit']))
{
  ...
  $MRP = $_POST['MRP'];
  $Price = $_POST['Price'];
  $up = mysqli_query($con,"UPDATE nod SET Name='".$Name."', Discription ='".$Discription."', MRP='".$MRP."' , Price='".$Price."' WHERE Id='".$Id."'");
  header("Location:Nodeedit.php");
}
?>
<form action ="Nodeedit1.php" method="post">
