...
$edit = $_GET['edit'];
$re = mysqli_query($con,"SELECT * FROM snack WHERE Id ='$edit'");
...
if(isset($_POST['submit']))
{
  ...
  $MRP = $_POST['MRP'];
  $Price = $_POST['Price'];
  $up = mysqli_query($con,"UPDATE snack SET Name='".$Name."', Discription ='".$Discription."', MRP='".$MRP."' , Price='".$Price."' WHERE Id='".$Id."'");
  header("Location:Snackedit.php");
}
?>
<form action ="Snackedit1.php" method="post">
