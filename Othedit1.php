...
$edit = $_GET['edit'];
$re = mysqli_query($con,"SELECT * FROM other WHERE Id ='$edit'");
...
if(isset($_POST['submit']))
{
  ...
  $MRP = $_POST['MRP'];
  $Price = $_POST['Price'];
  $up = mysqli_query($con,"UPDATE other SET Name='".$Name."', Discription ='".$Discription."', MRP='".$MRP."' , Price='".$Price."' WHERE Id='".$Id."'");
  header("Location:Othedit.php");
}
?>
<form action ="Othedit1.php" method="post">
