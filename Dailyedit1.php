...
$edit = $_GET['edit'];
$re = mysqli_query($con,"SELECT * FROM daily WHERE Id ='$edit'");
...
if(isset($_POST['submit']))
{
  ...
  $MRP = $_POST['MRP'];
  $Price = $_POST['Price'];
  $up = mysqli_query($con,"UPDATE daily SET Name='".$Name."', Discription ='".$Discription."', MRP='".$MRP."' , Price='".$Price."' WHERE Id='".$Id."'");
  header("Location:edit.php");
}
?>
<form action ="Dailyedit1.php" method="post">
