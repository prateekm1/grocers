...
$edit = $_GET['edit'];
$re = mysqli_query($con,"SELECT * FROM roil WHERE Id ='$edit'");
...
if(isset($_POST['submit']))
{
  ...
  $MRP = $_POST['MRP'];
  $Price = $_POST['Price'];
  $up = mysqli_query($con,"UPDATE roil SET Name='".$Name."', Discription ='".$Discription."', MRP='".$MRP."' , Price='".$Price."' WHERE Id='".$Id."'");
  header("Location:Roiledit.php");
}
?>
<form action ="Roiledit1.php" method="post">
