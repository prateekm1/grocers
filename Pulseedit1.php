...
$edit = $_GET['edit'];
$re = mysqli_query($con,"SELECT * FROM pulse WHERE Id ='$edit'");
...
if(isset($_POST['submit']))
{
  ...
  $MRP = $_POST['MRP'];
  $Price = $_POST['Price'];
  $up = mysqli_query($con,"UPDATE pulse SET Name='".$Name."', Discription ='".$Discription."', MRP='".$MRP."' , Price='".$Price."' WHERE Id='".$Id."'");
  header("Location:Pulseedit.php");
}
?>
<form action ="Pulseedit1.php" method="post">
