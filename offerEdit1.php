...
$edit = $_GET['edit'];
$re = mysqli_query($con,"SELECT * FROM offer WHERE Id ='$edit'");
...
if(isset($_POST['submit']))
{
  ...
  $MRP = $_POST['MRP'];
  $Price = $_POST['Price'];
  $up = mysqli_query($con,"UPDATE offer SET Name='".$Name."', Discription ='".$Discription."', MRP='".$MRP."' , Price='".$Price."' WHERE Id='".$Id."'");
  header("Location:offerEdit.php");
}
?>
<form action ="offerEdit1.php" method="post">
