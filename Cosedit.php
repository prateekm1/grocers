...
{
	$del =($_GET['id']);
	$query ="DELETE FROM cos WHERE Id ='$del'";
...
<?php 
        ...
        $result=mysqli_query($con,"SELECT * FROM cos");
        $count = 0;
			...
			<div class="col-md-4" style="border: 1px solid grey;width:230px">
				  ...
				  <h3>  <?php echo $res['Name'];?></h3>
				   <p>  <?php echo $res['Discription'];?></p>
					...
					<p>
						<a href="Cosedit.php?id=<?php echo ($res['Id']); ?>">Delete</a>	</p>
						<a href="Cosedit1.php?edit=<?php echo ($res['Id']); ?>">Edit</a>			
                   </center>
