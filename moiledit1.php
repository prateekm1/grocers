...
$edit = $_GET['edit'];
$re = mysqli_query($con,"SELECT * FROM moil WHERE Id ='$edit'");
...
if(isset($_POST['submit']))
{
  ...
  $MRP = $_POST['MRP'];
  $Price = $_POST['Price'];
  $up = mysqli_query($con,"UPDATE moil SET Name='".$Name."', Discription ='".$Discription."', MRP='".$MRP."' , Price='".$Price."' WHERE Id='".$Id."'");
  header("Location:moiledit.php");
}
?>
<form action ="moiledit1.php" method="post">
