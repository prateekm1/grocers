...
$edit = $_GET['edit'];
$re = mysqli_query($con,"SELECT * FROM tea WHERE Id ='$edit'");
...
if(isset($_POST['submit']))
{
  ...
  $MRP = $_POST['MRP'];
  $Price = $_POST['Price'];
  $up = mysqli_query($con,"UPDATE tea SET Name='".$Name."', Discription ='".$Discription."', MRP='".$MRP."' , Price='".$Price."' WHERE Id='".$Id."'");
  header("Location:Teaedit.php");
}
?>
<form action ="Teaedit1.php" method="post">
