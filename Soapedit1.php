...
$edit = $_GET['edit'];
$re = mysqli_query($con,"SELECT * FROM soap WHERE Id ='$edit'");
...
if(isset($_POST['submit']))
{
  ...
  $MRP = $_POST['MRP'];
  $Price = $_POST['Price'];
  $up = mysqli_query($con,"UPDATE soap SET Name='".$Name."', Discription ='".$Discription."', MRP='".$MRP."' , Price='".$Price."' WHERE Id='".$Id."'");
  header("Location:Soapedit.php");
}
?>
<form action ="Soapedit1.php" method="post">
